...
//
//        String result = read1To10(number);
//        String result2=read11to20(number);
////         OUTPUT
//        System.out.println(result);
//        System.out.println(result2);
//        String result3= readTy(number);
//        System.out.println(result3);
//        String result4=readOver100(number);
//        System.out.println(result4);
        ...
        if (number>=1&&number<=10){
            ...
            result=readOver100((number/100)*100)+ " and " +readTy(((number%100)/10)*10)+" "+read1To10(number%10);
        }
        System.out.println(result);
    }
